<template>
  <q-page class="bg-black">
    <q-toolbar class="bg-transparent" elevatio="0">
      ...
      />
      <q-space></q-space>
      <p class="q-ml-md datos text-white q-mt-md">Eventos disponibles</p>
      <q-space></q-space>
      <q-btn
        class="text-white"
        to="newcancion/new"
    ...
    <div class="row">
      <div class="col">
        <q-card class="q-ma-md roundedcard">
          <q-input class="q-mx-md" v-model="filter" label="Buscar evento">
...
const editar = (evt, row) => {
  router.push({ path: "codigoinv/" + row.idfiesta });
};
